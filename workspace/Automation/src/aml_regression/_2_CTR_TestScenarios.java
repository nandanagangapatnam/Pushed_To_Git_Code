...
public class _2_CTR_TestScenarios {
	...
	public void  _3_admin_login () throws Exception{
		...
		new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
		new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlData[109][11]);
				...
				if(driver.findElements(By.xpath(xpath)).size() != 0){	
				 ...
				 if (xlTransaction .equals("Money Order Non-Integrated no Cart")  ){
					...
					for (int k = i + 1 ; k <= i + 2 ; k++){
						...
						if (B_Cust_Name .equals("Ladawnya Adair")|| B_Cust_Name .equals("Nicki Bellomy") ||  B_Cust_Name .equals("michael mryant") || B_Cust_Name .equals("Mecha Godzilla") || B_Cust_Name .equals("Lord Business")){
