...
public class _4_NA_TestScenarios {
	...
	public void  _3_admin_login () throws Exception{
		...
		new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
		new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlData[77][11]);
	...
	public void _4_AML() throws Exception {
		...
		for ( int i = 1 ; i<=194 ; i++){	
			...
			if (  xlVerification .equals("N/A")    ){
				...
				new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlCustName);
					
				xpath =".//*[@id='ctl00_MainContent_CustSrch_btnSubmit']";  // click on Search button
				new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
					
				Thread.sleep(1000);
				xpath =".//*[@id='Block']/div[3]/div[2]/ul/li";  
				if(driver.findElements(By.xpath(xpath)).size() != 0){	
					
					i=i+1;
					System.out.println(xlCustName +"does not exist-please check the data");
				 ...
				 if (xlTransaction .equals("Money Order Non-Integrated no Cart")  ){
					 ...
					 if(xlCustName .equals("Justin Barber") || xlCustName .equals("Paul Bryson") || xlCustName .equals("Justin Rodgers")){
						 ...
						 Thread.sleep(1000);
							...
							new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
							new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
							new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlCheckDate);
					 ...
					 if (xlVoid .equals("Void Transaction")){
							...
							new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
							new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
						// new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlData[1][11]);
							new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlCheckDate);
					 ...
					 if(xlCustName .equals("Justin West")|| xlCustName .equals("Laura Bohl")|| xlCustName .equals("Paul Warden")|| xlCustName .equals("Justin Kent")){
					...
					//		new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlData[1][11]);
					 ...
					 if(xlCustName .equals("Julio Alvarado") || xlCustName .equals("Sherrie Lowe") || xlCustName .equals("Paul Bryson") ) {
					...
					//	new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlData[1][11]);
					 ...
					 if(xlCustName .equals("Aleta Fleming") || xlCustName .equals("Laura Bohl") || xlCustName .equals("Paul Warden") ) {
		...
		//				new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlData[1][11]);
					...
					if(xlCustName .equals("justin rodgers")){
					...
					if(xlCustName .equals("Justin Kent")){
					...
					String Name = xlData[j][1];
					 if (Name .equals("Construction Business") || Name .equals("My least favorite business")|| Name .equals("My Favorite Business") || Name .equals("Another Business")){
						...
						new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
						new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
						new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlData[i][11]);
	...
	@Test (priority = 5)
	public void _5_CloseBrowser() throws Exception {
