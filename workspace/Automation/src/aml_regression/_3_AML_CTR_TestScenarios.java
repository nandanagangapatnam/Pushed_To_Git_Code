...
public class _3_AML_CTR_TestScenarios {
	...
	public void  _3_admin_login () throws Exception{
		...
		new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
		new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlData[3][11]);
	...
	public void _4_AML() throws Exception {
		...
		for ( int i = 1 ; i<=194 ; i++){	
			...
			if ( xlVerification .equals("AML/CTR") ){
