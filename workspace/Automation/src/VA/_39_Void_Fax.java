package VA;
	...
	public class _39_Void_Fax {
		...
		@Test (priority = 4)
		public void Fax_No_Cust_No_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			 System.out.println("Fax_No_Cust_No_Cart  -- Started");
			...
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']", "Faxes");  // selecting the Faxes
			...
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtAmount']", "2.00");  // Enter Amount from customer
			//driver.findElement(By.xpath(xpath)).sendKeys(Keys.TAB);	
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$2.00")){
			 xlData[1][18] = "Verifying Fax_No_Cust_No_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][18] = "Verifying Fax_No_Cust_No_Cart Failed";
			 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[1][20] = "Voiding Fax_No_Cust_No_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[1][20] = "Voiding Fax_No_Cust_No_Cart Failed";
				 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
			 }
			 
			 System.out.println("Fax_No_Cust_No_Cart  -- Passed");
	}

		
		@Test (priority = 5)
		public void Fax_No_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	

			System.out.println("Fax_No_Cust_with_Cart  -- Started");		
			xpath = ".//*[@id='Left']/a[7]";  // clicking on tools left navigation
			Function_Classes.field_click(driver,xpath);
			...
			Thread.sleep(3000);
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtAmount']", "2.00");   /// entering the amount from customer
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$2.00")){
			 xlData[2][18] = "Verifying Fax_No_Cust_with_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][18] = "Verifying Fax_No_Cust_with_Cart Failed";
			 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[2][20] = "Voiding Fax_No_Cust_with_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[2][20] = "Voiding Fax_No_Cust_with_Cart Failed";
				 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
			 }
			 System.out.println("Fax_No_Cust_with_Cart  -- Passed"); 
	}
		
		
		@Test (priority = 6)
		public void Fax_with_Cust_No_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			System.out.println("Fax_with_Cust_No_Cart  -- Started");
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$2.00")){
			 xlData[1][18] = "Verifying Fax_with_Cust_No_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][18] = "Verifying Fax_with_Cust_No_Cart Failed";
			 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[1][20] = "Voiding Fax_with_Cust_No_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[1][20] = "Voiding Fax_with_Cust_No_Cart Failed";
				 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
			 }
			 System.out.println("Fax_with_Cust_No_Cart  -- Passed");
	}

		@Test (priority = 7)
		public void Fax_With_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	

			System.out.println("Fax_With_Cust_with_Cart  -  Strated");	
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$2.00")){
			 xlData[2][18] = "Verifying Fax_With_Cust_with_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][18] = "Verifying Fax_With_Cust_with_Cart Failed";
			 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[2][20] = "Voiding Fax_With_Cust_with_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[2][20] = "Voiding Fax_With_Cust_with_Cart Failed";
				 Utils.writeXL(OR.getProperty("vwpath"),"Login",xlData);
			 }
			 System.out.println("Fax_With_Cust_with_Cart  -- Passed"); 
