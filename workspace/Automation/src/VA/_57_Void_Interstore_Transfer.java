...
*/							
							Thread.sleep(3500);
							String Drawer_status = ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_rptstore_vault_counts_ctl02_lnkOpenClose']";  // Vault Drawer status
							String drawer_name = Function_Classes.field_gettext(driver, Drawer_status); // reading the value (open or close)
							System.out.println("Drawer Amount       " +drawer_name);
							Thread.sleep(vSleep);
			...
			public void Inter_Strore_Transfer() throws Exception {
				...
				//Function_Classes.index_select(driver,".//*[@id='ctl00_ctl00_MainContent_ChildContent1_cboTransferTo']",143);  //  click 7989 AUtomation OH	
				
				Function_Classes.field_sendKeys(driver, xpath, "7989 Automation Test Store, OH");//Automation Test Store, OH
				
				
				Thread.sleep(3500);
				Function_Classes.field_sendKeys(driver,".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBill100']", "1");  //  enter the $100 bill  amount
				...
				Thread.sleep(3500);
				xpath =".//*[@id='ctl00_ctl00_MainContent_ChildContent1_rptstore_vault_counts_ctl05_lblBalance']";
			...
			Thread.sleep(3500);
			xpath=".//*[@id='ddlStore']";  // selecting the state 
			//String keys = "7989 Automation Test Store, OH";
			Function_Classes.field_sendKeys(driver, xpath, "7989 Automation Test Store, OH");
			...
			Thread.sleep(3500);			
			Function_Classes.field_click (driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_liVoid']/a");  // cliking on  Void transaction
			
			Thread.sleep(3500);			
			Function_Classes.field_click (driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_btnGo']");  // clicking on submit button
			
			Thread.sleep(3500);			
			Function_Classes.field_click (driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_dgList_ctl02_lnkStore']");  // clicking on link  button
			...
			Thread.sleep(3500);			
			Function_Classes.field_click (driver, ".//*[@id='ctl00_ctl00_AppLeftNav_lnkOpenDrawer']");  // clicking on Open drawer
			
			
			Thread.sleep(3500);			
			String final_val= Function_Classes.field_gettext(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_rptstore_vault_counts_ctl05_lblBalance']");  // reading the drawer value
			...
			Thread.sleep(3500);			
			String final_val1= Function_Classes.field_gettext(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_rptstore_vault_counts_ctl05_lblBalance']");  // reading the drawer value
