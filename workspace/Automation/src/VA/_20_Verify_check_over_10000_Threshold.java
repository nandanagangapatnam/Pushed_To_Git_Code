	...
	public void Open_Drawer() throws Exception {
	 ...
	 // MO for more than $3500
			...
			//xlData = Utils.readXL(path,"TestData");	
			 ...
			 // creating customer 
				...
				Function_Classes.field_click(driver,xpath);
					...
					Thread.sleep(3000);
					xpath = ".//*[@id='CheckDate_txtDate']";  // Enter the date 
					Function_Classes.field_sendKeys(driver, xpath, "5/01/2016");
					...
					Thread.sleep(3000);
					xpath = ".//*[@id='btnStep1Submit']";  // click  the Next button 
					Function_Classes.field_click(driver,xpath);
					
					Thread.sleep(3000);
					xpath = ".//*[@id='btnStep2Submit']";  // click  the Submit button 
					Function_Classes.field_click(driver,xpath);
					
					Thread.sleep(3000);
					xpath = ".//*[@id='lblPayoutMsg']";   //  checking for the confirmation
					...
					Thread.sleep(3000);
					xpath = ".//*[@id='btnContinue']";  // click  the continue button 
					Function_Classes.field_click(driver,xpath);
		...
		public void Check_Void() throws Exception {
			...
			Thread.sleep(3000);
			xpath = ".//*[@id='dgOutstanding']/tbody/tr[2]/td[1]/a";  // click  the Outstanding check link  
			Function_Classes.field_click(driver,xpath);
			...
			Thread.sleep(3000);
			xpath = ".//*[@id='btnDelSubmit']";  // click  Submit button 
			Function_Classes.field_click(driver,xpath);
