...
public class _04_Create_EPP_DueDate_14 {
	...
	public void  _1_admin_login () throws Exception{
		...
		Function_Classes.field_sendKeys(driver1, xpath, xlData[5][3]);
		...
		new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + xlData[5][13]);
...
//	 	Thread.sleep(2000);	
	...
	// entering Identification 
		...
		new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys("3/10/2017");
		...
		PayFreq.selectByVisibleText("10th and 25th");
...
@Test (priority = 5)
		...
		for (int i = 5; i < 9; i = i + 1){
			...
			if ( i==5)
				...
				else if  ( i == 6 )
				{
				    ...
				    xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBusDate']";  // Business Date
			        new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
					new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "03/23/2017");
				...
				//	creating EPP after origination date and before due date 
					...
					xpath = ".//*[@id='ctl00_MainContent_CustSrch_txtLoanId']"; // enter loan id  value  
					new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlResults1[6][3]);
				...
				else if  ( i == 7 )
				{
			        ...
			        xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBusDate']";  // Business Date
			        new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
    				new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "03/24/2017");
			...
			//			Thread.sleep(2000);
						...
						xpath = ".//*[@id='ctl00_MainContent_CustSrch_txtLoanId']"; // enter loan id  value  
						new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlResults1[7][3]);
	...
	//					BusDate = Function_Classes.field_gettext(driver,xpath);
				...
				else if  ( i == 8 )
				{
						...
						xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBusDate']";  // Business Date
						new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
			        	new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "03/25/2017");
					 ...
					 //creating EPP After due date 
						...
						xpath = ".//*[@id='ctl00_MainContent_CustSrch_txtLoanId']"; // enter loan id  value  
						new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlResults1[8][3]);
	...
	public void  _6_businessdatebacktoOriginal () throws Exception{
        ...
        xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBusDate']";  // Business Date
        new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
		new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + xlData[5][14]);
