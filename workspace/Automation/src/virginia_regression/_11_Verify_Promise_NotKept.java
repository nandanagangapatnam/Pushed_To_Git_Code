...
public class _11_Verify_Promise_NotKept {
...
//		Thread.sleep(1000);
	...
	public void  _5_businssdate_rolledforward_beyond_duedate()throws Exception{
		...
		xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBusDate']";  // Business Date
	   	new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
	   	new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "05/01/2017");
	...
	public void  _6_homescreen_before_appointment_creation()throws Exception{
		...
		if (Late .contains("Day")){
			...
			if ( driver.findElements(By.xpath(xpath)).size() == 0  ){//&& celltext .equals(name)){
				...
				xlResults[2][3] ="APPT is coming under ActionItems but not under Appointments on Home Screen before appt creation - PASSED";
				Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
			}
			else{
			
				System.out.println("FAIL1");
				xlResults[2][3] ="APPT is not coming under ActionItems/coming under Appointments on Home Screen before appt creation - FAILED";
				Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
			}
...
//			Assert.assertEquals(celltext, name);
			...
			xlResults[2][3] = "Customer is Not Late - Check data";
			Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
		}
	}	
	...
	public void  _7_appointment_creation()throws Exception{
		...
		new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlResults[2][1]);;
		...
		if ( driver.findElements(By.xpath(xpath)).size() !=0){
			...
			if (Date.equals("05/05/2017 9:00 AM") && PromiseKept .equals("N/A") && Note .equals("TEST-CUSTOMER WILL COME")){
					...
					xlResults[2][4] = Date;
					xlResults[2][6] = PromiseKept;
					xlResults[2][5] = Note;	
	//				xlResults[2][6] = "YES -PASS";
					Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
	...
	public void  _8_homeScreen_on_appointment_creationdt()throws Exception{
		...
		if (xlResults[2][6] .equals("N/A")){
			...
			if ( driver.findElements(By.xpath(xpath)).size() == 0){// && celltext .equals("Not Present")){
				...
				System.out.println("PASS1");
				xlResults[2][7] ="APPT is not coming under ActionItems and Appointments on Home Screen - PASSED";
				Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
			}
			else{
			
				System.out.println("FAIL1");
				xlResults[2][7] ="APPT is coming under ActionItems/Appointments on Home Screen - FAILED";
				Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
			}
	...
	//		Assert.assertEquals(celltext, "Not Present");
		...
		xlResults[2][7]="Check the DATA for Intial Promise Kept";
		Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
	...
	public void  _9_homeScreen_3days_priortoappointment_creationdt()throws Exception{
		...
		if (xlResults[2][6] .equals("N/A")){
			...
			xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBusDate']";  // Business Date
		   	new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
		   	new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "05/02/2017");
			...
			if ( driver.findElements(By.xpath(xpath)).size() == 0){// && celltext .equals("Not Present")){
				...
				xlResults[2][8] ="APPT is not coming under Action Items and Appointments on Home Screen - PASSED";
				...
				xlResults[2][8] ="APPT is coming under Action Items/Appointments on Home Screen - FAILED";
...
//			Assert.assertEquals(celltext, "Not Present");
		...
		System.out.println("Check the DATA");
		xlResults[2][8]="Check the DATA for Intial Promise Kept";
		Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
	...
	public void  _10_homescreen_2days_priortoapptdt()throws Exception{
		...
		if (xlResults[2][6] .equals("N/A")){
			...
			xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBusDate']";  // Business Date
			new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
			new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "05/03/2017");
			...
			if ( driver.findElements(By.xpath(xpath)).size() !=0 /*&& celltext .equals("Not Present")*/){
				...
				xlResults[2][9] ="APPT is coming under Appointments but not under ActionItems on Home Screen - PASSED";
				...
				xlResults[2][9] ="APPT is not coming under Appointments/coming under ActionItems on Home Screen - FAILED";
...
//			Assert.assertEquals(celltext, "Not Present");
		...
		xlResults[2][9]="Check the DATA for Initial Promise Kept";
		Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
		
	}

		Assert.assertEquals(xlResults[2][6], "N/A");
}
	
	@Test (priority = 11)
	public void  _11_homescreen_beyondapptdt()throws Exception{
		...
		if (xlResults[2][6] .equals("N/A")){
			...
			xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtBusDate']";  // Business Date
			new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
			new WebDriverWait(driver1, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "05/06/2017");
			...
			if ( driver.findElements(By.xpath(xpath)).size() == 0 /*|| !celltext .equals("Not Present")*/){
				...
				System.out.println("FAIL3");
				xlResults[2][10]="APPT is not coming under Appointments and coming under Action Items on Home Screen before payment -FAILED";
				Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
				Assert.assertEquals(0, driver.findElements(By.xpath(xpath)).size());
				Assert.assertEquals(celltext, name);
				...
				xlResults[2][10]="APPT is coming under Appointments and not coming under Action Items on Home Screen before payment -PASSED";
				new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
				...
				if (Date.equals("05/05/2017 9:00 AM") && PromiseKept .equals("N/A") && Note .equals("TEST-CUSTOMER WILL COME")){
					...
					xpath =".//*[@id='ctl00_ctl00_MainContent_ChildContent1_Appointments_chkNotKept']"; //checkbox
					new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath)));
									
					WebElement checkbox = driver.findElement(By.id("ctl00_ctl00_MainContent_ChildContent1_Appointments_chkNotKept"));
					if(checkbox.isSelected()){
						
						System.out.println("FAIL CHKBOX ");
						xlResults[2][11]="Appointment was Kept is automatically checked - FAILED";
						Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
						...
						xlResults[2][11]="Appointment was Kept is not automatically checked - PASSED";
						Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
					...
					xpath =".//*[@id='ctl00_ctl00_MainContent_ChildContent1_Appointments_btnSubmit']"; //submit
					new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
					...
					if (Date1.equals("05/05/2017 9:00 AM") && PromiseKept1 .equals("No") && Note1 .equals("TEST-CUSTOMER WILL COME")){
					
						System.out.println("PASS POST CHECKBOX click");
						...
						String name =xlCustLName+", "+xlCustFName;
						System.out.println(name);
						WebElement table1 = driver.findElement(By.id("ctl00_MainContent_pnlActionItems")); 
					...
					Thread.sleep(1000);				
					 ...
					 if ( driver.findElements(By.xpath(xpath)).size() == 0 /*&& celltext. equals(name)*/){	
							...
							xlResults[2][12] ="APPT is not coming under Appointments but coming under ActionItems post Promise was not kept on Home Screen - PASSED";
							Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
							...
							xlResults[2][12] ="APPT is coming under Appointments or not under ActionItems post Promise was not kept on Home Screen - FAILED";
							Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);
						}
...
//						Assert.assertEquals(celltext,name);
						...
						System.out.println("FAIL POST CHECKBOX click");
						xlResults[2][12] ="PromiseKept,Date and Note are not coming correctly post Appt was kept is checked- FAILED ";
						Utils.writeXL(OR.getProperty("vLOCPromiseKept"),"VA_LOC",xlResults);	
					}
						...
						xpath =".//*[@id='ctl00_MainContent_CustSrch_txtLoanId']";  // Save
						new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlResults[2][1]);;
						...
						Assert.assertEquals(PromiseKept1, "No");
			...
			System.out.println("Check the DATA");
			xlResults[2][10]="Check the DATA for initial promise kept - FAIL";
			xlResults[2][11]="Check the DATA for initial promise kept - FAIL";
	...
	@Test (priority = 12)
	public void _12_businessdatebacktoOriginal() throws Exception {
	...
	@Test (priority = 13)
	public void _13_log_out_teller() throws Exception {
