...
public class _1_Create_EPP2_Nandana {
	...
	String URL1 = "http://ecashtest.corp.checksmart.com/setup/store.aspx?action=view&id=208";
	...
	public void  _1_admin_login () throws Exception{
		...
		Function_Classes.field_sendKeys(driver1, xpath, xlData[2][3]);
		...
		new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "12/19/2016");
	...
	@Test (priority = 4)
	public void newcustomer_Creation() throws Exception {
	
		
		System.out.println("Ecash New Customer Creation   --  Started");
		
		xlResults1 = Utils.readXL(OR.getProperty("iwpath"),"IN_EPP");
...
//		Thread.sleep(1000);
	...
	//	Thread.sleep(2000);
		...
		//Ident Details
			...
			new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys("12/03/2016");
			...
			PayFreq.selectByVisibleText("Monthly on 3rd");
			...
			System.out.println(xlrCustLName);
...
//			Thread.sleep(2000);
	...
	//		Thread.sleep(2000);
			...
			Utils.writeXL(OR.getProperty("iwpath"),"IN_EPP",xlResults1);
		}
		...
		//			Thread.sleep(1000);
					xpath=".//*[@id='ctl00_ctl00_MainContent_ChildContent1_lnkEdit']";  // Clearing Password field
					new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
			        ...
			        new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
			        new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
					driver1.findElement(By.xpath(xpath)).sendKeys(Keys.HOME + "01/02/2017");
	...
	//		        Thread.sleep(3000);
		...
		//				Thread.sleep(3500);
				...
				else if  ( i == 4 )
				{
			        ...
			        new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
			        new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
					driver1.findElement(By.xpath(xpath)).sendKeys(Keys.HOME + "01/03/2017");
...
//			        Thread.sleep(3000);
		...
		//				Thread.sleep(3500);
	        ...
	        new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).clear();
	        new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).click();
	        new WebDriverWait(driver1, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(Keys.HOME + "01/04/2017");
...
//				Thread.sleep(3500);
				xpath = ".//*[@id='ctl00_MainContent_CustSrch_txtLoanId']"; // enter loan id  value  
				new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).sendKeys(xlResults1[5][3]);	
...
//				Thread.sleep(3000);
				...
				Thread.sleep(1000);
			 	...
			 	Thread.sleep(1000);
			 	xpath =".//*[@id='ctl00_ctl00_MainContent_ChildContent1_rptPmtPlan_Plan_ctl01_txtPmtPlan_ChkNum']";
			 	...
			 	if(driver.findElements( By.xpath(xpath)).size() != 0){
					...
					Status = new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).getText();
					System.out.println(Status);
					xlResults1[5][8] = Status;
					
					Thread.sleep(1000);
					xpath =".//*[@id='ctl00_ctl00_MainContent_ChildContent1_LoanDetail_vwDueDate']";  // check#2
					DueDate = new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).getText();
					System.out.println(DueDate);
					xlResults1[5][9] = DueDate;
					
					Thread.sleep(1000);
					xpath =".//*[@id='ctl00_ctl00_MainContent_ChildContent1_LoanDetail_vwOrigDate']";  // check#2
					OriDate = new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath))).getText();
					System.out.println(OriDate);
					xlResults1[5][10] = OriDate;
					...
					System.out.println(BusDate);
					String BDate = BusDate.substring(15);
					xlResults1[5][11] = "EPP is enabled post duedate" +BDate;
				...
				else 
				{
					...
					System.out.println(BusDate);
					String BDate = BusDate.substring(15);
					xlResults1[5][11] = "EPP can not be done post due date" +BDate;
	...
	public void  BusinessdatebacktoOriginal () throws Exception{
		...
		driver1.findElement(By.xpath(xpath)).sendKeys(Keys.HOME + "12/19/2016");
