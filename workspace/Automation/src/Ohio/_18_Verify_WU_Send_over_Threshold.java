...
public class _18_Verify_WU_Send_over_Threshold {
	...
	public void Open_Drawer() throws Exception {
	 ...
	 // MO for more than $3500
		@Test (priority = 4)
		public void WU_Send_over_Threshold() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			 System.out.println("WU_Send_over_Threshold   --  Started");
			 ...
			 // creating customer 
			   /* xlCustFName = xlData [1][4];
				...
				Function_Classes.field_click(driver,xpath);
					...
					Thread.sleep(vSleep+2000);
					//Select oSelect6 = new Select(driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']")));   // selecting the Wire Trans Send - WU
					...
					Thread.sleep(3500);	 
					 ...
					 if (drawerfinalamt.equals("$3004.00")){
					...
					Thread.sleep(vSleep+3000);	
					System.out.println("WU_Send_over_Threshold   --  Passed");
