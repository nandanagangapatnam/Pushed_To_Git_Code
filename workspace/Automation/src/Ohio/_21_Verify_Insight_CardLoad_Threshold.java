...
public class _21_Verify_Insight_CardLoad_Threshold {
	...
	public void Open_Drawer() throws Exception {
	 ...
	 // MO for more than $3500
		@Test (priority = 4)
		public void Insight_Cardload_Threshold() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			 System.out.println("Insight_Cardload_Threshold    --   Started");
			 ...
			 // creating customer 
				...
				Function_Classes.field_click(driver,xpath);
					...
					driver.findElement(By.xpath(xpath)).sendKeys(Keys.BACK_SPACE);
					Function_Classes.field_sendKeys(driver,xpath , "3002");  // Enter Amount
					...
					Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtAmount']", "3004");  // Enter Amount from customer
					//driver.findElement(By.xpath(xpath)).sendKeys(Keys.TAB);	
					...
					Thread.sleep(vSleep+3000);
					Select oSelect8 = new Select(driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']")));   // selecting the Insight Card Load
					oSelect8.selectByIndex(11);	
					...
					Thread.sleep(3500);	 
					 ...
					 if (drawerfinalamt.equals("-$100.00")){
						 xlData[1][18] = "Verifying Insight_Cardload_Threshold sucessfull";
						 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
					 }
					 else
					 {
						 xlData[1][18] = "Verifying Insight_Cardload_Threshold Failed";
						 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
					 }
					 ...
					 xpath = ".//*[@id='Left']/a[7]";  // clicking on tools left navigation
						...
						Thread.sleep(3500);	 
						 ...
						 if (drawerfinalamt1.equals("$0.00")){
							 xlData[1][20] = "Voiding Insight_Cardload_Threshold sucessfull";
							 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
						 }
						 else
						 {
							 xlData[1][20] = "Voiding Insight_Cardload_Threshold Failed";
							 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
						 }
					
						 System.out.println("Insight_Cardload_Threshold    --   Passed");
