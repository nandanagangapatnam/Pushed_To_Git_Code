...
public class _15_Verify_ATM_with_Cart {
	...
	// To Open / reopen the Cash Drawer
			...
			public void Open_Drawer() throws Exception {
				...
				Thread.sleep(3500);
				String Drawer_status = ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_rptstore_vault_counts_ctl02_lnkOpenClose']";  // Drawer status
			...
			public void ATM_With_Cust_with_Cart() throws Exception {
				...
				Thread.sleep(3000);
				Function_Classes.field_click(driver,".//*[@id='ctl00_ctl00_AppLeftNav_lnkCart']");  // clicking on Tools in left navigation 
				
				//Thread.sleep(3000);
				//Function_Classes.field_click(driver,".//*[@id='ctl00_ctl00_MainContent_ChildContent1_cart2_rptcart_ctl01_lnkCancelCart']");  // clicking on Abandon link
