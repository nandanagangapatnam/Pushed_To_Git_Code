...
public class AML_Multi_Customer_Loan_Creation {
	...
	// New Customer Creation  - working fine
				...
				public void newcustomer() throws Exception {
					xlData = Utils.readXL(path,"TestData");	
					tcRows = xlData.length;
					System.out.println("length is " + tcRows);
					for (int i = 1; i < tcRows; i = i + 1){
					...
					Thread.sleep(2000);					  
					Select oSelect = new Select(driver.findElement(By.xpath(".//*[@id='FrmCustAddress_cboType']"))); // Select Address Type :  Home
					oSelect.selectByIndex(2);
					
					Thread.sleep(1000);
					xpath =".//*[@id='FrmCustAddress_txtAddrLine1']"; // entering Address
					Function_Classes.field_sendKeys(driver, xpath, xlData [i][14]);
					
					Thread.sleep(1000);
					xpath =".//*[@id='FrmCustAddress_txtCity']"; // entering City
					Function_Classes.field_sendKeys(driver, xpath, xlData [i][15]);
					...
					Function_Classes.field_sendKeys(driver, xpath, xlData [i][16]);
	...
	//  loan creation 
					...
					Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_FrmCustEmploymentInfo_txtEmployer']", xlData [i][17]); // Employer Name
					
					Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_FrmCustEmploymentInfo_txtOccupation']", xlData [i][18]); // Occupation  Name
				
					Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_FrmCustEmploymentInfo_txtJobPayAmt']",  xlData [i][19]); // Pay Amount
					
					Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_FrmCustEmploymentInfo_dbxJobLastPayDate_txtDate']", xlData [i][20]); // Pay Date
		           ...
		           Thread.sleep(2000);
					...
					xlData [i][24]=Function_Classes.field_gettext(driver,".//*[@id='ctl00_ctl00_MainContent_ChildContent1_LoanDetail_lnkLoanId']");
					}
