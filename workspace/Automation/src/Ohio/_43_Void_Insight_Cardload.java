...
public class _43_Void_Insight_Cardload {
	...
	@Test (priority = 4)
	public void Insight_with_Cust_No_Cart() throws Exception {
		//xlData = Utils.readXL(path,"TestData");	
		System.out.println("Insight_with_Cust_No_Cart   --  Started");
		...
		Thread.sleep(vSleep+3500);
		//Select oSelect = new Select(driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']")));   // selecting the Insight Card Load
		//oSelect.selectByIndex(11);	
		Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']", "Insight Card Load");

		Thread.sleep(3500);
		Function_Classes.field_click(driver, ".//*[@id='Main']/div[1]");
					
		Thread.sleep(3500);
		xpath = ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_cbNonIntegrated']";// clicking on the Process Manually check box
		...
		if (misc_assert_val.equals("Insight CardLoad Confirmation")) {
			xlData[1][14] = "Pass";
	...
	Thread.sleep(3500);	 
	 ...
	 if (drawerfinalamt.equals("$102.00")){
		 xlData[1][18] = "Insight CardLoad sucessfull";
		 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
	 }
	 else
	 {
		 xlData[1][18] = "Insight CardLoad Failed";
		 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
	 }
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt1.equals("$0.00")){
			 xlData[1][20] = "Insight CardLoad sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][20] = "Insight CardLoad Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 System.out.println("Insight_with_Cust_No_Cart   --  Passed");
}

	@Test (priority = 5)
	public void Insight_With_Cust_with_Cart() throws Exception {
		//xlData = Utils.readXL(path,"TestData");	

		System.out.println("Insight_With_Cust_with_Cart  --  Started");	
	...
	Thread.sleep(3500);	 
	 ...
	 if (drawerfinalamt.equals("$102.00")){
		 xlData[2][18] = "Insight CardLoad sucessfull";
		 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
	 }
	 else
	 {
		 xlData[2][18] = "Insight CardLoad Failed";
		 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
	 }
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt1.equals("$0.00")){
			 xlData[2][20] = "Insight CardLoad sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][20] = "Insight CardLoad Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 System.out.println("Insight_With_Cust_with_Cart    --  Passed"); 
