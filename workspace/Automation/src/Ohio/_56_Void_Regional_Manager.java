...
public class _56_Void_Regional_Manager {
	...
	public void  date () throws InterruptedException{
        ...
        Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_MainContent_cboRegion']", "Tennessee");
	...
	Thread.sleep(3500);	 
	 ...
	 Thread.sleep(2000);
		...
		// Thread.sleep(3500);
		// Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_LocSelector_cboStore']", "9989 Automation Test Store, TN"); // selecting Store
		 ...
		 Thread.sleep(3500);
			Function_Classes.field_click(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_btnGo']");  // click on Submit button
			 ...
			 Thread.sleep(3500);
		        Function_Classes.field_link(driver, "9989 Automation Test Store, TN");// clicking on transction link
			...
			Thread.sleep(vSleep+3500);	
			 ...
			 Thread.sleep(2000);
		       ...
		       // Function_Classes.index_select(driver, ".//*[@id='ctl00_MainContent_cboUserType']", 2);  // user type
		        ...
		        Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_MainContent_cboDistrict']", "Tennessee  - Chattanooga District");        
