	...
	public  void  StroreLogin () throws Exception{
		...
		Thread.sleep(vSleep+3000);			
			...
			public void Deposit_Check_Void () throws Exception{
			   ...
			   Function_Classes.field_sendKeys(driver, ".//*[@id='cboCheckType']","Money Order" );// selecting MO 
			   
			   Thread.sleep(3000);		
			  
				Function_Classes.field_click(driver,".//*[@id='txtCheckNum']");  // clicking on check number field
				 Thread.sleep(3000);
				Function_Classes.field_sendKeys(driver, ".//*[@id='txtCheckNum']", xlcheckno);// enter check number
				...
				Thread.sleep(3000);
				Function_Classes.field_gettext(driver, ".//*[@id='lblPayoutMsg']"); // confirming the transaction - reading  "Amount to Customer"
				
				Thread.sleep(3000);
				Function_Classes.field_click(driver,".//*[@id='btnContinue']");  // clicking on continue button
				
				Thread.sleep(3000);
				Function_Classes.field_click(driver,".//*[@id='dgOutstanding']/tbody/tr[2]/td[1]/a");  // clicking on Check hyper link button
				...
				Thread.sleep(3000);  //  refocusing on main window
				...
				Thread.sleep(2000);
				Function_Classes.logout1(driver, ".//*[@id='menuv2']/li[7]/a", ".//*[@id='AppHeader_btnLogout']"); // click on Deposit Cashed checks// for log out 
