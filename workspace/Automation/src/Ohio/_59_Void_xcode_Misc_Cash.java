...
import Functions.Function_Classes;
	...
	public class _59_Void_xcode_Misc_Cash {
		...
		public void xcode_No_Cust_No_Cart() throws Exception {
			...
			Thread.sleep(vSleep+2000);
			Select oSelect = new Select(driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']")));   // selecting the X General Insurance
		...
		public void xcode_No_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(OR.getProperty("OR.getProperty("wpath")"),"TestData");	
		...
		public void xcode_with_Cust_No_Cart() throws Exception {
			...
			Function_Classes.field_sendKeys(driver, xpath, "Good 603"); 
			...
			//Function_Classes.field_click(driver,xpath);
			Function_Classes.field_link(driver,"Customer, Good 603");
