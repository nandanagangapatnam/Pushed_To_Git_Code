...
//import org.apache.bcel.generic.Select;
	...
	public class _42_Void_WU_BillPay {
		...
		@Test (priority = 4)
		public void WU_Billpay__No_Cust_No_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			 System.out.println("WU_Billpay__No_Cust_No_Cart ---  Started");
			...
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']", "Bill Pay – WU CONV Pay");
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$102.00")){
			 xlData[1][18] = "Verifying WU_Billpay__No_Cust_No_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][18] = "Verifying WU_Billpay__No_Cust_No_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[1][20] = "Voiding WU_Billpay__No_Cust_No_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[1][20] = "Voiding WU_Billpay__No_Cust_No_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 
			 System.out.println("WU_Billpay__No_Cust_No_Cart   -- Passed");
	}

		
		@Test (priority = 5)
		public void WU_Billpay_No_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	

			System.out.println("WU_Billpay_No_Cust_with_Cart  -- Started");		
			xpath = ".//*[@id='Left']/a[7]";  // clicking on tools left navigation
			Function_Classes.field_click(driver,xpath);
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$102.00")){
			 xlData[2][18] = "Verifying WU_Billpay_No_Cust_with_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][18] = "Verifying WU_Billpay_No_Cust_with_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[2][20] = "Voiding WU_Billpay_No_Cust_with_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[2][20] = "Voiding WU_Billpay_No_Cust_with_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("WU_Billpay_No_Cust_with_Cart    -- Passed"); 
	}
		
		
		@Test (priority = 6)
		public void WU_BillPay_with_Cust_No_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			System.out.println("WU_BillPay_with_Cust_No_Cart   -- Started");
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$102.00")){
			 xlData[1][18] = "Verifying WU_BillPay_with_Cust_No_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][18] = "Verifying WU_BillPay_with_Cust_No_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[1][20] = "Voiding WU_BillPay_with_Cust_No_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[1][20] = "Voiding WU_BillPay_with_Cust_No_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("WU_BillPay_with_Cust_No_Cart   -- Passed");
	}

		@Test (priority = 7)
		public void WU_Billpay_With_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	

			System.out.println("WU_Billpay_With_Cust_with_Cart  -- Started");	
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$102.00")){
			 xlData[2][18] = "Verifying WU_Billpay_With_Cust_with_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][18] = "Verifying WU_Billpay_With_Cust_with_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[2][20] = "Voiding WU_Billpay_With_Cust_with_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[2][20] = "Voiding WU_Billpay_With_Cust_with_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("WU_Billpay_With_Cust_with_Cart  --  Passed"); 
