...
import Functions.Function_Classes;
	...
	public class _36_Void_Charity {
		...
		@Test (priority = 4)
		public void Charity_No_Cust_No_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			 System.out.println("Charity_No_Cust_No_Cart  -- Started");
			...
			Thread.sleep(vSleep+1000);
			//Select oSelect = new Select(driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']")));   // selecting the ATM Withdrawls
			//oSelect.selectByIndex(4);	
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']", "Charity/Fundraiser");
...
*/				
			...
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtAmount']", "100");  // Enter Amount from customer
			//driver.findElement(By.xpath(xpath)).sendKeys(Keys.TAB);	
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$100.00")){
			 xlData[1][18] = "Verifying Charity_No_Cust_No_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][18] = "Verifying Charity_No_Cust_No_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[1][20] = "Voiding Charity_No_Cust_No_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[1][20] = "Voiding Charity_No_Cust_No_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 
			 System.out.println("Charity_No_Cust_No_Cart  -- Passed");
	}

		
		@Test (priority = 5)
		public void Charity_No_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	

			System.out.println("Charity_No_Cust_with_Cart  -- Started");		
			xpath = ".//*[@id='Left']/a[7]";  // clicking on tools left navigation
			Function_Classes.field_click(driver,xpath);
			...
			Thread.sleep(vSleep+1000);
			//Select oSelect = new Select(driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']")));   // selecting the  ATM Withdrawals
			//oSelect.selectByIndex(4);	
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']", "Charity/Fundraiser");
...
*/				
			...
			Thread.sleep(3000);
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtAmount']", "100");   /// entering the amount from customer
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$100.00")){
			 xlData[2][18] = "Verifying Charity_No_Cust_with_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][18] = "Verifying Charity_No_Cust_with_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[2][20] = "Voiding Charity_No_Cust_with_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[2][20] = "Voiding Charity_No_Cust_with_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("Charity_No_Cust_with_Cart -- Passed"); 
	}
		
		
		@Test (priority = 6)
		public void Charity_with_Cust_No_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			System.out.println("Charity_with_Cust_No_Cart  -- Started");
			...
			Thread.sleep(vSleep+3000);
			//Select oSelect = new Select(driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']")));   // selecting the Charity
			//oSelect.selectByIndex(4);	
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']", "Charity/Fundraiser");
...
*/				
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$100.00")){
			 xlData[1][18] = "Verifying Charity_with_Cust_No_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][18] = "Verifying Charity_with_Cust_No_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[1][20] = "Voiding Charity_with_Cust_No_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[1][20] = "Voiding Charity_with_Cust_No_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("Charity_with_Cust_No_Cart  --  Passed");
	}

		@Test (priority = 7)
		public void Charity_With_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	

			System.out.println("Charity_With_Cust_with_Cart  -- Started");	
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$100.00")){
			 xlData[2][18] = "Verifying Charity_With_Cust_with_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][18] = "Verifying Charity_With_Cust_with_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[2][20] = "Voiding Charity_With_Cust_with_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[2][20] = "Voiding Charity_With_Cust_with_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("Charity_With_Cust_with_Cart -- Passed"); 
