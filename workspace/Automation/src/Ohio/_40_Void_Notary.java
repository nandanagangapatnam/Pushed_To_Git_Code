...
import Functions.Function_Classes;
	...
	public class _40_Void_Notary {
		...
		@Test (priority = 4)
		public void Notary_No_Cust_No_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			 System.out.println("Notary_No_Cust_No_Cart  --  Started");
			...
			//oSelect.selectByIndex(16);	
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_ddlItems']", "Notary");
			...
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtAmount']", "4.50");  // Enter Amount from customer
			//driver.findElement(By.xpath(xpath)).sendKeys(Keys.TAB);	
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$4.50")){
			 xlData[1][18] = "Verifying Notary_No_Cust_No_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][18] = "Verifying Notary_No_Cust_No_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[1][20] = "Voiding Notary_No_Cust_No_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[1][20] = "Voiding Notary_No_Cust_No_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 
			 System.out.println("Notary_No_Cust_No_Cart   --  Passed");
	}

		
		@Test (priority = 5)
		public void Notary_No_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	

			System.out.println("Notary_No_Cust_with_Cart --  Started");		
			xpath = ".//*[@id='Left']/a[7]";  // clicking on tools left navigation
			Function_Classes.field_click(driver,xpath);
			...
			Thread.sleep(3500);
			Function_Classes.field_sendKeys(driver, ".//*[@id='ctl00_ctl00_MainContent_ChildContent1_txtAmount']", "4.50");   /// entering the amount from customer
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$4.50")){
			 xlData[2][18] = "Verifying Notary_No_Cust_with_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][18] = "Verifying Notary_No_Cust_with_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[2][20] = "Voiding Notary_No_Cust_with_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[2][20] = "Voiding Notary_No_Cust_with_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("Notary_No_Cust_with_Cart  -- Passed"); 
	}
		
		
		@Test (priority = 6)
		public void Notary_with_Cust_No_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	
			System.out.println("Notary_with_Cust_No_Cart  -- Started");
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$4.50")){
			 xlData[1][18] = "Verifying Notary_with_Cust_No_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[1][18] = "Verifying Notary_with_Cust_No_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[1][20] = "Voiding Notary_with_Cust_No_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[1][20] = "Voiding Notary_with_Cust_No_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("Notary_with_Cust_No_Cart  --  Passed");
	}

		@Test (priority = 7)
		public void Notary_With_Cust_with_Cart() throws Exception {
			//xlData = Utils.readXL(path,"TestData");	

			System.out.println("Notary_With_Cust_with_Cart  -- Started");	
		...
		Thread.sleep(3500);	 
		 ...
		 if (drawerfinalamt.equals("$4.50")){
			 xlData[2][18] = "Verifying Notary_With_Cust_with_Cart sucessfull";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
		 else
		 {
			 xlData[2][18] = "Verifying Notary_With_Cust_with_Cart Failed";
			 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
		 }
			...
			Thread.sleep(3500);	 
			 ...
			 if (drawerfinalamt1.equals("$0.00")){
				 xlData[2][20] = "Voiding Notary_With_Cust_with_Cart sucessfull";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 else
			 {
				 xlData[2][20] = "Voiding Notary_With_Cust_with_Cart Failed";
				 Utils.writeXL(OR.getProperty("wpath"),"Login",xlData);
			 }
			 System.out.println("Notary_With_Cust_with_Cart  -- Passed"); 
